...
npm dist-tag add koishi-plugin-onebot-info-image@x.y.z-beta.w+yyyymmdd latest --registry https://registry.npmjs.org

npm view koishi-plugin-onebot-info-image --registry https://registry.npmjs.org
npm-stat.com
```
